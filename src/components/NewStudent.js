...
const NewStudent = () => {
  ...
  const[grade, setGrade] = useState('P0');
  ...
  const handleRegister = (e) => {
    ...
    if (checkBtn.current.context._errors.length === 0) {
      AuthService.register(username, email, password, firstname, lastname, grade, title, phoneNumber).then(
        (response) => {
            ...
            <div>
              ...
              <div className="form-group">
                ...
                <select value={grade} onChange={onChangeGrade}>
                    <option value="P0">Beginner</option>
                    <option value="P1">Practitioner 1</option>
                    <option value="P2">Practitioner 2</option>
                    <option value="P3">Practitioner 3</option>
                    <option value="P4">Practitioner 4</option>
                    <option value="P5">Practitioner 5</option>
